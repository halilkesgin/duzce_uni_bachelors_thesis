...
class AdminSocialItemController extends Controller
{
    public function show()
    {
        ...
        return view('admin.social_item.show', compact('social_item_data'));
    }

    public function create()
    {
        return view('admin.social_item.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.social_item.edit', compact('social_item_data'));
    }
