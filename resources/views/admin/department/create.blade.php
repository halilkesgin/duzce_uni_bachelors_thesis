                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group mb-3">
                            ...
                            <textarea name="dep_schema" class="form-control summernote"></textarea>
                        </div>
                        <div class="form-group mb-3">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="head_1">
                        </div>
                        <div class="form-group mb-3">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea name="dep_com" class="form-control summernote"></textarea>
                        </div>
                    </div>
                </div>
                <h6>İletişim</h6>
