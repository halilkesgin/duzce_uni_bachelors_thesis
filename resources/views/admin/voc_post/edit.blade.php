...
<div class="section-body">
    <form action="{{ route('admin_voc_post_update',$post_single->id) }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select name="department_id" class="form-control select2">
                                ...
                                <option value="{{ $item->id }}" @if($item->id == $post_single->department_id) selected @endif>{{ $item->title }} ({{ $item->rVocational->title }})</option>
                                @endforeach
                            </select>
                        </div>
