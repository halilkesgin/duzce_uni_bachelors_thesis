...
@section('main_content')
    <section class="wrapper bg-soft-primary">
        <div class="container pt-7 pb-7 pt-md-7 pb-md-7 ">
            <div class="row">
                <div class="col-md-12 ">
                    <h6 class="display-6">Duyurular</h6>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-md-12 ">
                    @foreach ($announcement_data as $data)
                        ...
                        @endphp
                        <div class="job-list">
                            <a href="{{ route('announcement_show',$data->id) }}" class="card4 mb-4 lift">
                                <div class="card-body p-5">
                                    <span class="row justify-content-between align-items-center">
                                        <span class="col-md-3 mb-2 mb-md-0 d-flex align-items-center text-body">
                                            <span class="avatar2 bg-danger text-white w-13 h-13 fs-17 me-3">{{$date}}</span> {{$data->title;}}
                                        </span>
