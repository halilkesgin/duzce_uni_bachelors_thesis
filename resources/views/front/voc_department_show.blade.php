                    ...
                    <div class="card">
                        <div class="card-body">
                            <ul class="nav nav-tabs nav-tabs-basic" style="display: block;">
                                ...
                                <li class="nav-item"> <a class="nav-link" data-bs-toggle="tab" href="#tab2">Akademik</a> </li>
                                <li class="nav-item"> <a class="nav-link" data-bs-toggle="tab" href="#tab3">İdari</a> </li>
                                <h4 class="mt-5">ÖĞRENCİ</h4>
                                <li class="nav-item"> <a class="nav-link" data-bs-toggle="tab" href="#tab4">Duyurular</a> </li>
                                <h4 class="mt-5">İLETİŞİM</h4>
                                <li class="nav-item"> <a class="nav-link" data-bs-toggle="tab" href="#tab5">Bilgiler</a> </li>
                            </ul>
                        </div>
                    </div>
                </div>
